...
if(isset($_POST['submit'])){
	...
	if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
  	...
  	$insert_data = "INSERT INTO student_data(u_card, u_f_name, u_l_name, u_father, u_nid, u_birthday, u_gender, u_email, u_phone, u_divi, u_dist, u_address, u_police, u_pincode, u_mother, u_family, staff_id,image,uploaded) VALUES ('$u_card','$u_f_name','$u_l_name','$u_father','$u_nid','$u_birthday','$u_gender','$u_email','$u_phone','$u_divi','$u_dist','$u_address','$u_police','$u_pincode','$u_mother','$u_family','$u_staff_id','$image',NOW())";
...
<body>
	<div class="container">
<a href="https://www.facebook.com/cyberlightsbd" target="_blank"><center><img src="images/Cyber_light's_logo.png" width="150px" height="150px" alt=""></center></a><hr>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      <div class="modal-header">
		...
		<!--<center><img src="images/Cyber_light's_logo.png" width="200px" height="200px" alt=""></center>-->
      </div>
...
<input type="text" class="form-control" name="user_nid" maxlength="12" placeholder="Enter NID no. ">
</div>
</div>
<div class="form-row">
<div class="form-group col-md-6">
...
<input type="text" class="form-control" name="family" placeholder="Enter number">
</div>
<div class="rm-group col-md-6">
...
<label for="inputdivi">Division</label>
			...
			<div class='container' id='profile'> 
				<div class='row'>
					...
					<div class='col-sm-3 col-md-6'>
						...
						<i class='fa fa-home' aria-hidden='true'> Address : </i> $address, $police, <br> $dist, $divi - $pincode
						<br />
						</p>
						<!-- Split button -->
					</div>
  ...
  <div class='modal-dialog'>
    ...
    <div class='modal-content'>
      ...
      <div class='modal-body'>
		...
		<div class='form-group col-md-6'>
		<label for='nidno'>NID No.</label>
		<input type='text' class='form-control' name='user_nid' maxlength='12' placeholder='Enter NID no. ' value='$nid'>
		</div>
		</div>
		<div class='form-row'>
		<div class='form-group col-md-6'>
		...
		<input type='text' class='form-control' name='staff_id' maxlength='12' placeholder='Enter Staff Id' value='$staffCard'>
		</div>
        	<div class='form-group'>
        		<label>Image</label>
        		<input type='file' name='image' class='form-control'>
